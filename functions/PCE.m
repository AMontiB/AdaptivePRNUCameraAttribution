function [Out,denom,peakheight,Out0] = PCE(C,shift_range,squaresize)
% -------------------------------------------------------------------------
...
denom=PCE_energy;
Out.PCE = peakheight.^2/PCE_energy * sign(peakheight); %the one that I estract
...
%Out0.PCE = correl^2/PCE_energy; %the optional one
