...
function [PCE_not,CPCE, CPCE_fing] = ADAPTIVE_Inv_and_Dir_H0(im,Fingerprint, transf_idx, flag_direct, tau_c)
...
if exist(im,'file')
    img=imread(im);
    [img,Fingerprint]=crop_in_center(img,Fingerprint);
    fingersize = size(Fingerprint);
