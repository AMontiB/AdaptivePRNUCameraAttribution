...
function noise2 = PRNU_transformer(noise, k, ri, ro,r, theta,R,xi,yi,center,ut,vt, flag_rc,varargin)

    index = find(r>ri/R & r<=ro/R);
    s(1:length(r),1) = 255;
    s(index) = distortfun(r(index),k,flag_rc);
    s2 = s * R;    
